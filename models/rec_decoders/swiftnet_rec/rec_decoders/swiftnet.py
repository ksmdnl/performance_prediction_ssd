...
class SwiftNetDecoder(nn.Module):
    def __init__(self, block=BasicBlock, delta_d=0, idlc=[0,0,0], route='lat_bw', *, num_features=128, k_up=3, use_bn=True, use_skips=True, use_spp=False, inplanes=64, dims=[96, 192, 384, 768]):
